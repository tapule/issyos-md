...
{
    /* Pause game command */
    *SMD_VDP_PORT_CTRL_W = SMD_VDP_REG_KMOD_CONTROL | 0x00;
}
...
void __kdebug_alert(const char *str)
{
    ...
    while (*c)
    {
        *SMD_VDP_PORT_CTRL_W = SMD_VDP_REG_KMOD_MESSAGE | *c;
        ++c;
    }
...
void __kdebug_timer_start(void)
{
    ...
    *SMD_VDP_PORT_CTRL_W = SMD_VDP_REG_KMOD_TIMER | 0x80;
}

void __kdebug_timer_stop(void)
{
    /* Stop and output emulator timer command */
    *SMD_VDP_PORT_CTRL_W = SMD_VDP_REG_KMOD_TIMER | 0x40;
}

void __kdebug_timer_output(void)
{
    /* Output emulator timer command */
    *SMD_VDP_PORT_CTRL_W = SMD_VDP_REG_KMOD_TIMER | 0x00;
}
