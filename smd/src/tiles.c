...
inline void smd_tiles_load(const void *restrict src, const uint16_t tile_index,
...
inline void smd_tiles_load_fast(const void *restrict src, const uint16_t tile_index,
                            const uint16_t length)
{
